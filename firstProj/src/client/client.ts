...
const camera1 = new THREE.PerspectiveCamera(100, 1, 0.1, 100);
const camera2 = new THREE.OrthographicCamera(-0.5, 0.5, 0.5, -0.5, 0.1, 100);
...
camera2.lookAt(new THREE.Vector3(5 , 0, 0));
